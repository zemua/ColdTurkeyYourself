...
public class GruposNegativosAdapter extends GruposAdapter {
    ...
    public GruposNegativosAdapter(List<Grupo> dataset, Context context, TimeLogHandler timeLogHandler, LifecycleOwner owner, Application app, ConditionCheckerCommander checker) {
